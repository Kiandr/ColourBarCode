...
- (IBAction)StartAuthentication:(UIButton*)sender {
    ...
    //ManageButton(sender);
    Operator->StartStopButton = !Operator->StartStopButton;
    _onOffButton = sender;
    [self ManageButton];
...
- (void) ManageButton {
    ...
    if (Operator->StartStopButton)
    {
        ...
        [_onOffButton setTitle:@"Click to Stop!" forState:UIControlStateSelected];
        [self viewWillAppear:Operator->StartStopButton];
         }
    else {
        Operator->StartStopButton = FALSE;
        [_onOffButton setSelected:NO];
        [_onOffButton setTitle:@"Click to Start Again!" forState:!UIControlStateSelected];
...
- (IBAction)toggleMovieRecording:(id)sender
{
    ...
    dispatch_async( self.sessionQueue, ^{
        if ( ! self.movieFileOutput.isRecording ) {
            ...
            [ViewController setFlashMode:AVCaptureFlashModeOff forDevice:self.videoDevice];
...
- (IBAction)changeCamera:(id)sender
{
    ...
    dispatch_async( self.sessionQueue, ^{
        ...
        AVCaptureDevice *newVideoDevice = [ViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:preferredPosition];
...
- (IBAction)snapStillImage:(id)sender
{
    dispatch_async( self.sessionQueue, ^{
        ...
        if ( self.videoDevice.exposureMode == AVCaptureExposureModeCustom ) {
            ...
            [ViewController setFlashMode:AVCaptureFlashModeAuto forDevice:self.videoDevice];
        }
